    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-5 text-lg">預約系統</h1>
				...
				<div class="portflio-item position-relative mb-4">
					<a href="im_reservation_majang.html">
						...
						<div class="portfolio-item-content">
							<h3 class="mb-0 text-white">麻將</h3>
			...
			<div class="col-lg-4 col-md-6">
				<div class="portflio-item position-relative mb-4">
					<a href="im_reservation_cabinet.html">
						...
						<div class="portfolio-item-content">
							<h3 class="mb-0 text-white">系櫃</h3>
							<p class="text-white-50">Web Development</p>
						</div>
					</a>
				</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="portflio-item position-relative mb-4">
					<a href="im_reservation_sofa.html">
						...
						<div class="portfolio-item-content">
							<h3 class="mb-0 text-white">沙發</h3>
							<p class="text-white-50">Web Development</p>
						</div>
					</a>
				</div>
