	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="case-study-content text-center mb-5">
					<h2 class="mb-4">快上桌!</h2>
					<p>超級熱門，再不預約就只能在旁邊遞水了==</p>
				</div>
			</div>
		</div>
		...
		<div class="case-timeline">
			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="case-img ">
						<img src="images/about/morning.jpg" alt="" class="img-fluid">
					</div>
				</div>
				<div class="col-lg-6">
			...
			<div class="row align-items-center">	
				<div class="col-lg-6 order-2 order-lg-1">
					<div class="case-content">
						...
						<p>還有空位</p>
                        <a href="im_mahang_schedule.html" class="btn btn-main">立即預約</a>
					</div>
				</div>
				<div class="col-lg-6  order-1 order-lg-2">
					<div class="case-img">
						<img src="images/about/noon.jpg" alt="" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="case-timeline">
			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="case-img">
						<img src="images/about/sunset.jpg" alt="" class="img-fluid">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="case-content">
		...
		<div class="case-timeline">
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6  order-1 order-lg-2">
					<div class="case-img">
						<img src="images/about/moon.jpg" alt="" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
